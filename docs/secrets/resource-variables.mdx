...
- [Secrets and Variables](./overview.mdx) — Overview of project-level secrets and variables
- [Project Level Secrets and Variables](./project-level-secrets.mdx) — Define, edit, and set per-environment values
- [Resource Connections](./resource-connections.mdx) — Use secret and variable references in resource configuration fields
