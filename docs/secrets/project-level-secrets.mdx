...
See [Resource Connections](./resource-connections.mdx) for how these expressions are used in resource configuration fields.
...
- [Secrets and Variables](./overview.mdx) - Overview of secrets and variables in Facets
- [Resource Variables](./resource-variables.mdx) - Environment variable configuration for individual resources
- [Resource Connections](./resource-connections.mdx) - How to use reference expressions in resource configuration
