...
- [Creating a Project](./creating-a-project.mdx) — How to set up a new project from scratch
- [Project Settings](./project-settings.mdx) — Configure GitOps, CI/CD, and general project metadata
