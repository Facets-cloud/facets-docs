...
- [Project Settings](./project-settings.mdx) — full settings panel including GitOps, CI/CD, and Danger Zone
- [Project Overview](./overview.mdx) — environment-level actions including Release and Launch
- [Variables and Secrets](../secrets/overview.mdx) — how variable counts are surfaced from synced metadata
