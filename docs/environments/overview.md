...
Environments can be arranged in a **Delivery Pipeline** that establishes a parent-child promotion order. A release must be signed off in a parent environment before it flows to dependent (child) environments. See [Dependent Environments](./dependent-environments.md) for details.
...
- [Environment Configurations](./configurations.md) — Overview dashboard, access details, monitoring, and alerts
- [Launching and Destroying Environments](./launching-destroying.md) — Create, launch, destroy, and delete environments
- [Environment Settings](./settings.md) — General settings, environment type, release management, IaC, VPN, and danger zone
- [Dependent Environments](./dependent-environments.md) — Delivery pipelines and sign-off policies
- [Overriding Resources in an Environment](./overriding-resources.md) — Per-environment resource configuration overrides
- [Template Inputs](./template-inputs.md) — Blueprint-level parameters configured per environment
