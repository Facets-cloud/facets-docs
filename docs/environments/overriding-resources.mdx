...
- [Environment Settings](./settings.mdx) — General environment configuration options
- [Template Inputs](./template-inputs.mdx) — Project-level parameters that affect multiple resources across an environment
